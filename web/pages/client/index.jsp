	...
	<script type="text/javascript">
		$(function () {
			...
			/*	$.getJSON("${basePath}cartServlet","action=ajaxAddItem&id=" + itemId,function (data) {
					console.log(data);
					$("#cartCountSpan").html("您的购物车中有 " + data.cartTotalCount + " 件商品");
					$("#cartLastNameDiv").html('您刚刚将<span style="color: red">' + data.cartLastName + '</span>加入到了购物车中');
				});*/
